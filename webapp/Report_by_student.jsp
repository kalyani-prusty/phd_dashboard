    ...
    <div class="container-r_u ">
        ...
        <table > 
            ...
            <tr> 
                ...
                <td><input type="text" value="${brname}"name="bname" /> 
                </td> 
            </tr> 
            <tr> 
                <td><label for="email"> 
            ...
            <tr> 
                ...
                <td><input type="number" value="${total_mark}" name="tot_marks" /> 
                </td> 
            </tr> 
            <tr> 
                ...
                <td><input type="text" value="${cgpa}" name="cgpa" /> 
                </td> 
            </tr> 
            <tr> 
                <td><label for=" grade"> 
                ...
                <td><input type="text" value="${grades }" name="grades" /> 
                </td> 
            </tr> 
