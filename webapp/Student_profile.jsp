...
<header>
  ...
  <div class="dropdown-content">
    <a href="Report card.jsp">REPORT</a>
    <a href="Attendance.jsp">CLASS</a>
    ...
    <div class="container-r_u">
        ...
        <form action="#" method="post">
                ...
                <div class="input-boxr">
                    ...
                    <input type="text" value="${name }"  name="fname" readonly="readonly">
                    
                </div>
                <div class="input-boxr">
                    <span class="details">User Name</span>
                    <input type="text"  value="${uname }" name="uname" readonly="readonly">
                </div>
                <div class="input-boxr">
                ...
                <div class="input-boxr">
                    ...
                    <input type="tel" value="${ phno}"  name="phno" readonly="readonly">
                </div>
                
                
                <div class="input-boxr">
                    <span class="details">Branch </span>
                    <input type="text" value="${ branch }" name="branch" readonly="readonly">
                </div>
                <div class="input-boxr">
                    <span class="details">Date Of Enroll</span>
                    <input type="date" value="${ dt_en}"  name="date" readonly="readonly">
                </div>
                
                <div class="input-boxr">
                    <span class="details">Gender</span>
                    <input type="text"  value="${gender }" name="Password" readonly="readonly">
                </div>
