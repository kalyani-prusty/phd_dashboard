...
<header>
  ...
  <div class="dropdown-content">
    ...
    <div class="container-r_u">
  		...
  		<form action="Class_attendance" method="post">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Enter Roll Number" name="roll">
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="Present or Not" name="atten">
    </div>
    <div class="col">
      <input type="date" class="form-control" placeholder="which date?" name="date">
    </div>
    <div class="col">
